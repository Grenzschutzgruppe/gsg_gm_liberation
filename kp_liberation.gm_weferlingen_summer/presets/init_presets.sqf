...
switch (KP_liberation_preset_civilians) do {
	...
	case 4: {[] call compileFinal preprocessFileLineNumbers "presets\civilians\german_80.sqf";};
...
KP_liberation_crates = [KP_liberation_supply_crate,KP_liberation_ammo_crate,KP_liberation_fuel_crate,FOB_box_typename];
